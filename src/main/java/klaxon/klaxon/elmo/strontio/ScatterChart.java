...
public class ScatterChart extends ApplicationFrame {
    ...
    public static void chart(String title, XYDataset data, String xLabel, String yLabel) {
        new ScatterChart(title, xLabel, yLabel, data).display();
    }

    private ScatterChart(String title, String xLabel, String yLabel, XYDataset data) {
        super(title);
        ChartPanel chartPanel = createDemoPanel(title, xLabel, yLabel, data);
        chartPanel.setPreferredSize(new java.awt.Dimension(500, 270));
        setContentPane(chartPanel);
    }

    public static ChartPanel createDemoPanel(String title, String xLabel, String yLabel, XYDataset data) {
        JFreeChart chart = createChart(title, xLabel, yLabel, data);
